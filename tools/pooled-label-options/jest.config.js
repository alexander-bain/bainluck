/**
 * Standalone jest config for the calibration divergence sweep (UX-P120 item 2).
 *
...
module.exports = {
  ...
  rootDir: repoRoot,
  roots: ["<rootDir>/tools/pooled-label-options", "<rootDir>/frontend"],
  testMatch: ["**/tools/pooled-label-options/**/*.sweep.ts"],
  watchman: false,
