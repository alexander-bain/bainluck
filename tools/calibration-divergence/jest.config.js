/**
 * Standalone jest config for the calibration divergence sweep (UX-P119 item 1).
 *
...
module.exports = {
  ...
  rootDir: repoRoot,
  roots: ["<rootDir>/tools/calibration-divergence", "<rootDir>/frontend"],
  testMatch: ["**/tools/calibration-divergence/**/*.sweep.ts"],
  watchman: false,
