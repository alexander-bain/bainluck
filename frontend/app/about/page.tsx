  ...
  return (
    <div className="max-w-3xl mx-auto space-y-10">
      ...
      <section className="space-y-4">
        ...
        >
          <span className={`transition-transform ${caseStudyOpen ? "rotate-90" : ""}`}>▸</span>
          Why Probability Matters
        </button>
        {caseStudyOpen && (
          <div className="space-y-6">
            {/* Story 1: Alcaraz */}
            <div className="bg-surface-card rounded-xl p-6 border border-surface-border space-y-3">
              <p className="text-xs font-semibold tracking-wider text-accent-brand uppercase">Case Study</p>
              <h3 className="font-semibold text-text-primary">Winning big, then barely surviving</h3>
              <p className="text-sm text-text-secondary leading-relaxed">
                2026 Australian Open semifinal. Carlos Alcaraz entered as the underdog
                at roughly <strong className="text-text-primary">20% win probability</strong>.
                He won the first two sets and surged past 85%. Then an adductor injury
                struck. His probability crashed through volatile swings across sets 3 and 4
                as Zverev fought back to level the match. In the decisive fifth set, Alcaraz
                broke back and won 7-5. The final scoreline &mdash; 3 sets to 2 &mdash;
                looks close. The probability chart on Kalshi ($27M volume) shows the real
                drama: wild swings from underdog to dominant to desperate to champion.
              </p>
              <p className="text-xs text-text-muted">
                Score: Alcaraz 6-4, 7-6, 6-7, 6-7, 7-5. Source: Kalshi market kxatpmatch-26jan29alczve.
              </p>
            </div>
            ...
            <div className="bg-surface-card rounded-xl p-6 border border-surface-border space-y-3">
              <p className="text-xs font-semibold tracking-wider text-accent-brand uppercase">Case Study</p>
              <h3 className="font-semibold text-text-primary">The leaderboard hides the real favorites</h3>
              <p className="text-sm text-text-secondary leading-relaxed">
                2025 Masters, end of Round 1. Rory McIlroy sat T1 on the leaderboard.
                But the prediction market didn&apos;t just agree with the leaderboard &mdash;
                it saw <em>how much</em> more likely McIlroy was to win than the other
                co-leaders. McIlroy held{" "}
                <strong className="text-text-primary">24.4% win probability</strong>,
                while co-leader Sam Burns had just 8.6%. Meanwhile, Scottie Scheffler
                sat T6 &mdash; a shot back &mdash; but the market gave him 19.0%, more
                than double most players above him. McIlroy went on to win. The
                leaderboard showed positions; probability showed conviction.
              </p>
              <p className="text-xs text-text-muted">
