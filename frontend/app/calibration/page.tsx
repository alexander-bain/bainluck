    ...
    <div className="max-w-4xl mx-auto space-y-8 pb-12">
      ...
      <section className="bg-surface-card rounded-xl p-5 border border-surface-border">
        ...
        <ul className="space-y-3 text-sm text-text-secondary">
          ...
          <li><strong className="text-text-primary">Which probability do we use?</strong> For sports with sportsbook data, we use the opening consensus odds across 20+ bookmakers (vig-removed). For prediction markets, we use the earliest price after meaningful trading activity began &mdash; not the initial placeholder price that exists before anyone has placed a trade.</li>
