...
export const STORY_BLEND = {
  ...
  body:
    "Sportsbooks, ESPN, prediction markets, and live stat models each have a guess. We weight them by track record and blend them into a single probability — the whole market's honest opinion, not one sportsbook's.",
