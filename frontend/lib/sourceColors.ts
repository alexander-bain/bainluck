...
export const SOURCE_COLORS: Record<string, SourceColor> = {
  ...
  // #4067 repair (CERT-2290): the second copy of the same label. Two
  // registries spelling one source two ways is #2442's rule; here they
  // spelled it the same and both were banned.
