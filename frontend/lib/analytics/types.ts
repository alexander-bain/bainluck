...
export interface PageViewParams {
  page_type: 'home' | 'event_detail' | 'sport' | 'error'
    ...
    | 'share' | 'golf' | 'golf_tournament' | 'event_concept' | 'category' | 'category_index' | 'admin_taxonomy' | 'admin_matching' | 'admin_cohort_views' | 'explore'
    | 'march_madness' | 'march_madness_picks' | 'playoff_grid' | 'oscars_pool'
    | 'leagues_index' | 'admin_dashboard' | 'admin_eval' | 'admin_discover_quality' | 'admin_story'
    | 'masters_live'
