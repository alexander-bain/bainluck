 ...
 * every timezone, UTC included. It is the same root UX-P179 fixed one block
 * higher up the same page, in `components/golf/CurrentEventBanner.tsx`: a
 * calendar date is a DAY when it is COMPARED, not only when it is PRINTED.
 *
 ...
 * finished tournament therefore kept a pulsing red LIVE dot. The three sibling
 * deciders of this same boundary all treat the window as a VETO instead:
 *
 ...
 *   components/golf/CurrentEventBanner.tsx           the window itself (end +24h)
 *
 * `_isLive` was the sole outlier of four. It now agrees with them.
 *
 * ═══ THE READER COUNT ═══
 *
...
describe("UX-P180 · the card and the banner agree about one tournament's window", () => {
  ...
  it("the banner and the card describe the same tournament", () => {
