 ...
 *
 * Produced by `git show 124cab6c:frontend/components/TournamentCard.tsx`, with
 * only the `"use client"` pragma removed (a fixture is never a route boundary)
 * and this header prepended. Nothing else is touched.
 *
 ...
 *
 * Precedents: `uxp179GolfCurrentEventBannerLegacy.tsx`,
 * `uxp178HubUpcomingCardLegacy.tsx`, `uxp177RelatedByTagLegacy.tsx`.
 *
