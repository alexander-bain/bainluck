...
export const CITIES: CityData[] = [
  { id: "nyc", name: "New York", preferredX: 30.8, preferredY: 41, x: 30.8, y: 41, region: "Americas", srcs: ["polymarket", "kalshi"],
  ...
  { id: "la", name: "Los Angeles", preferredX: 18.8, preferredY: 45.4, x: 18.8, y: 45.4, region: "Americas", srcs: ["polymarket", "kalshi"],
  ...
  { id: "mia", name: "Miami", preferredX: 31.2, preferredY: 51, x: 31.2, y: 51, region: "Americas", srcs: ["polymarket", "kalshi"],
  ...
  { id: "chi", name: "Chicago", preferredX: 26, preferredY: 38, x: 26, y: 38, region: "Americas", srcs: ["polymarket", "kalshi"],
  ...
  { id: "sfo", name: "San Francisco", preferredX: 16.5, preferredY: 42, x: 16.5, y: 42, region: "Americas", srcs: ["polymarket", "kalshi"],
  ...
  { id: "dal", name: "Dallas", preferredX: 24.5, preferredY: 47, x: 24.5, y: 47, region: "Americas", srcs: ["polymarket", "kalshi"],
  ...
  { id: "tor", name: "Toronto", preferredX: 29, preferredY: 37, x: 29, y: 37, region: "Americas", srcs: ["polymarket"],
  ...
  { id: "mex", name: "Mexico City", preferredX: 22.6, preferredY: 53, x: 22.6, y: 53, region: "Americas", srcs: ["polymarket"],
  ...
  { id: "sao", name: "São Paulo", preferredX: 35, preferredY: 67, x: 35, y: 67, region: "Americas", srcs: ["polymarket"],
  ...
  { id: "bue", name: "Buenos Aires", preferredX: 33, preferredY: 74, x: 33, y: 74, region: "Americas", srcs: ["polymarket"],
  ...
  { id: "lon", name: "London", preferredX: 49, preferredY: 33, x: 49, y: 33, region: "Europe", srcs: ["polymarket"],
  ...
  { id: "par", name: "Paris", preferredX: 50, preferredY: 34, x: 50, y: 34, region: "Europe", srcs: ["polymarket"],
  ...
  { id: "mad", name: "Madrid", preferredX: 48, preferredY: 38, x: 48, y: 38, region: "Europe", srcs: ["polymarket"],
    high: { unit: "C", mode: 20, dist: [
  ...
  { id: "ber", name: "Munich", preferredX: 52, preferredY: 33, x: 52, y: 33, region: "Europe", srcs: ["polymarket"],
  ...
  { id: "mos", name: "Moscow", preferredX: 57, preferredY: 28, x: 57, y: 28, region: "Europe", srcs: ["polymarket"],
  ...
  { id: "ist", name: "Istanbul", preferredX: 55, preferredY: 39, x: 55, y: 39, region: "Europe", srcs: ["polymarket"],
  ...
  { id: "tok", name: "Tokyo", preferredX: 83, preferredY: 39, x: 83, y: 39, region: "Asia", srcs: ["polymarket"],
  ...
  { id: "seo", name: "Seoul", preferredX: 81, preferredY: 38, x: 81, y: 38, region: "Asia", srcs: ["polymarket"],
  ...
  { id: "bei", name: "Beijing", preferredX: 78, preferredY: 37, x: 78, y: 37, region: "Asia", srcs: ["polymarket"],
  ...
  { id: "sha", name: "Shanghai", preferredX: 80, preferredY: 42, x: 80, y: 42, region: "Asia", srcs: ["polymarket"],
    high: { unit: "C", mode: 22, dist: [
  ...
  { id: "hkg", name: "Hong Kong", preferredX: 79, preferredY: 49, x: 79, y: 49, region: "Asia", srcs: ["polymarket"],
  ...
  { id: "sng", name: "Singapore", preferredX: 77, preferredY: 58, x: 77, y: 58, region: "Asia", srcs: ["polymarket"],
  ...
  { id: "knw", name: "Lucknow", preferredX: 71, preferredY: 48, x: 71, y: 48, region: "Asia", srcs: ["polymarket"],
  ...
  { id: "man", name: "Manila", preferredX: 83, preferredY: 54, x: 83, y: 54, region: "Asia", srcs: ["polymarket"],
  ...
  { id: "jak", name: "Jakarta", preferredX: 79, preferredY: 60, x: 79, y: 60, region: "Asia", srcs: ["polymarket"],
  ...
  { id: "krc", name: "Karachi", preferredX: 69, preferredY: 49, x: 69, y: 49, region: "Asia", srcs: ["polymarket"],
  ...
  { id: "cpt", name: "Cape Town", preferredX: 52, preferredY: 71, x: 52, y: 71, region: "Africa", srcs: ["polymarket"],
    high: { unit: "C", mode: 20, dist: [
  ...
  { id: "lag", name: "Lagos", preferredX: 50, preferredY: 57, x: 50, y: 57, region: "Africa", srcs: ["polymarket"],
    high: { unit: "C", mode: 32, dist: [
  ...
  { id: "wlg", name: "Wellington", preferredX: 92.5, preferredY: 76, x: 92.5, y: 76, region: "Oceania", srcs: ["polymarket"],
    high: { unit: "C", mode: 14, dist: [
  ...
  { id: "bos", name: "Boston", preferredX: 32, preferredY: 38, x: 32, y: 38, region: "Americas", srcs: ["kalshi"],
  ...
  { id: "atl", name: "Atlanta", preferredX: 28, preferredY: 47, x: 28, y: 47, region: "Americas", srcs: ["polymarket", "kalshi"],
  ...
  { id: "hou", name: "Houston", preferredX: 24, preferredY: 51, x: 24, y: 51, region: "Americas", srcs: ["polymarket", "kalshi"],
  ...
  { id: "den", name: "Denver", preferredX: 21, preferredY: 42, x: 21, y: 42, region: "Americas", srcs: ["polymarket", "kalshi"],
  ...
  { id: "sea", name: "Seattle", preferredX: 17, preferredY: 34, x: 17, y: 34, region: "Americas", srcs: ["polymarket", "kalshi"],
  ...
  { id: "phx", name: "Phoenix", preferredX: 19.5, preferredY: 47, x: 19.5, y: 47, region: "Americas", srcs: ["kalshi"],
  ...
  { id: "min", name: "Minneapolis", preferredX: 24, preferredY: 36, x: 24, y: 36, region: "Americas", srcs: ["kalshi"],
  ...
  { id: "phi", name: "Philadelphia", preferredX: 31, preferredY: 40, x: 31, y: 40, region: "Americas", srcs: ["kalshi"],
    high: { unit: "F", mode: 80.5, dist: [
      { label: "<74°F", prob: 3 }, { label: "74-76", prob: 8 }, { label: "77-79", prob: 18 }, { label: "80-82", prob: 38 }, { label: "83-85", prob: 22 }, { label: "86°F+", prob: 11 },
    ] },
  },
  { id: "lv", name: "Las Vegas", preferredX: 19, preferredY: 45, x: 19, y: 45, region: "Americas", srcs: ["kalshi"],
  ...
  { id: "okc", name: "Oklahoma City", preferredX: 23.5, preferredY: 45, x: 23.5, y: 45, region: "Americas", srcs: ["kalshi"],
  ...
  { id: "sat", name: "San Antonio", preferredX: 23, preferredY: 50, x: 23, y: 50, region: "Americas", srcs: ["kalshi"],
  ...
  { id: "nol", name: "New Orleans", preferredX: 26, preferredY: 50, x: 26, y: 50, region: "Americas", srcs: ["kalshi"],
  ...
  { id: "wdc", name: "Washington DC", preferredX: 30.5, preferredY: 42, x: 30.5, y: 42, region: "Americas", srcs: ["kalshi"],
  ...
  { id: "aus", name: "Austin", preferredX: 23.5, preferredY: 49, x: 23.5, y: 49, region: "Americas", srcs: ["polymarket", "kalshi"],
  ...
  { id: "ams", name: "Amsterdam", preferredX: 50.5, preferredY: 31, x: 50.5, y: 31, region: "Europe", srcs: ["polymarket"],
  ...
  { id: "hel", name: "Helsinki", preferredX: 54, preferredY: 26, x: 54, y: 26, region: "Europe", srcs: ["polymarket"],
    high: { unit: "C", mode: 13, dist: [
  ...
  { id: "tlv", name: "Tel Aviv", preferredX: 57, preferredY: 44, x: 57, y: 44, region: "Asia", srcs: ["polymarket"],
    high: { unit: "C", mode: 22, dist: [
  ...
  { id: "jed", name: "Jeddah", preferredX: 59, preferredY: 51, x: 59, y: 51, region: "Asia", srcs: ["polymarket"],
    high: { unit: "C", mode: 34, dist: [
      { label: "<29°C", prob: 2 }, { label: "29-30", prob: 6 }, { label: "31-32", prob: 16 }, { label: "33", prob: 24 },
  ...
  { id: "bus", name: "Busan", preferredX: 82, preferredY: 40, x: 82, y: 40, region: "Asia", srcs: ["polymarket"],
    high: { unit: "C", mode: 22, dist: [
  ...
  { id: "szn", name: "Shenzhen", preferredX: 79, preferredY: 51, x: 79, y: 51, region: "Asia", srcs: ["polymarket"],
  ...
  { id: "kul", name: "Kuala Lumpur", preferredX: 77, preferredY: 56, x: 77, y: 56, region: "Asia", srcs: ["polymarket"],
    high: { unit: "C", mode: 32, dist: [
  ...
  { id: "mil", name: "Milan", preferredX: 51, preferredY: 36, x: 51, y: 36, region: "Europe", srcs: ["polymarket"],
  ...
  { id: "pnm", name: "Panama City", preferredX: 26.5, preferredY: 55, x: 26.5, y: 55, region: "Americas", srcs: ["polymarket"],
  ...
  { id: "ank", name: "Ankara", preferredX: 56, preferredY: 41, x: 56, y: 41, region: "Europe", srcs: ["polymarket"],
    high: { unit: "C", mode: 13, dist: [
  ...
  { id: "wrw", name: "Warsaw", preferredX: 53, preferredY: 30, x: 53, y: 30, region: "Europe", srcs: ["polymarket"],
    high: { unit: "C", mode: 14, dist: [
