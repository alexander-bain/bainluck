...
set -u
OUT=/Users/bain/bainluck-dev/lane1/artifacts/lane1-090-anchor-sentinel-run.json
LOG=/Users/bain/bainluck-dev/lane1/artifacts/lane1-090-anchor-sentinel-watch.log
source ~/.claude/.env
