...
- [053](rulings/053-a-premise-waiting-item-is-re-anchored-at-every-run-start.md) — 2026-08-14 — A premise-waiting queue item is RE-ANCHORED against the world at every run start, then anchored or explicitly reported — never trusted from its header, because a gate that cannot fire must not look like a gate that passed (Alex)
