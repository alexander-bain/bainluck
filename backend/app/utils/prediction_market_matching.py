...
_KALSHI_TEAM_ABBREVS: dict[str, str] = {
    ...
    "laa": "Angels",
    # ── Soccer — EPL (suffixed with _soc to avoid collisions) ──
    "ars_soc": "Arsenal", "avl_soc": "Aston Villa", "bou_soc": "Bournemouth",
    "bre_soc": "Brentford", "bha_soc": "Brighton", "che_soc": "Chelsea",
    "cry_soc": "Crystal Palace", "eve_soc": "Everton", "ful_soc": "Fulham",
    "ips_soc": "Ipswich", "lei_soc": "Leicester", "liv_soc": "Liverpool",
    "mci_soc": "Manchester City", "mun_soc": "Manchester United",
    "new_soc": "Newcastle", "nfo_soc": "Nottingham Forest",
    "sou_soc": "Southampton", "tot_soc": "Tottenham",
    "whu_soc": "West Ham", "wol_soc": "Wolverhampton",
    "bur_soc": "Burnley", "lut_soc": "Luton", "she_soc": "Sheffield United",
    # ── Soccer — La Liga ──
    "rma_soc": "Real Madrid", "mad_soc": "Real Madrid",
    "fcb_soc": "Barcelona", "bar_soc": "Barcelona",
    "atm_soc": "Atletico Madrid",
    "bet_soc": "Real Betis", "sev_soc": "Sevilla", "vil_soc": "Villarreal",
    "ath_soc": "Athletic Club", "rso_soc": "Real Sociedad", "val_soc": "Valencia",
    "gir_soc": "Girona", "get_soc": "Getafe", "osa_soc": "Osasuna",
    "cel_soc": "Celta Vigo", "mal_soc": "Mallorca", "ray_soc": "Rayo Vallecano",
    "ala_soc": "Alaves", "esp_soc": "Espanyol", "las_soc": "Las Palmas",
    "leg_soc": "Leganes", "vll_soc": "Valladolid",
    # ── Soccer — Bundesliga ──
    "bay_soc": "Bayern Munich", "bvb_soc": "Borussia Dortmund",
    "rbl_soc": "RB Leipzig", "lev_soc": "Bayer Leverkusen",
    "bmg_soc": "Borussia Monchengladbach", "wob_soc": "Wolfsburg",
    "svw_soc": "Werder Bremen", "scf_soc": "SC Freiburg",
    "sge_soc": "Eintracht Frankfurt", "tsg_soc": "Hoffenheim",
    "m05_soc": "Mainz", "fca_soc": "Augsburg", "fcub_soc": "Union Berlin",
    "hdh_soc": "Heidenheim", "ksh_soc": "Holstein Kiel", "vfb_soc": "Stuttgart",
    "boc_soc": "Bochum", "dsc_soc": "Arminia Bielefeld",
    # ── Soccer — Serie A ──
    "juv_soc": "Juventus", "acm_soc": "AC Milan", "int_soc": "Inter Milan",
    "nap_soc": "Napoli", "rom_soc": "Roma", "laz_soc": "Lazio",
    "fio_soc": "Fiorentina", "ata_soc": "Atalanta", "bol_soc": "Bologna",
    "tor_soc": "Torino", "udi_soc": "Udinese", "emp_soc": "Empoli",
    "sas_soc": "Sassuolo", "gen_soc": "Genoa", "mon_soc": "Monza",
    "lec_soc": "Lecce", "cag_soc": "Cagliari", "ver_soc": "Verona",
    "sal_soc": "Salernitana", "fro_soc": "Frosinone",
    # ── Soccer — Ligue 1 ──
    "psg_soc": "Paris Saint-Germain", "asm_soc": "Monaco", "olm_soc": "Marseille",
    "ol_soc": "Lyon", "lil_soc": "Lille", "ren_soc": "Rennes",
    "nic_soc": "Nice", "len_soc": "Lens", "str_soc": "Strasbourg",
    "nan_soc": "Nantes", "tou_soc": "Toulouse", "mon_soc2": "Montpellier",
    "bre_soc2": "Brest", "rei_soc": "Reims", "leh_soc": "Le Havre",
    "ang_soc": "Angers", "aux_soc": "Auxerre", "steti_soc": "Saint-Etienne",
    # ── Soccer — MLS (suffixed with _mls) ──
    "atl_mls": "Atlanta United", "aus_mls": "Austin FC", "cha_mls": "Charlotte FC",
    "chi_mls": "Chicago Fire", "cin_mls": "FC Cincinnati",
    "col_mls": "Colorado Rapids", "clb_mls": "Columbus Crew",
    "dal_mls": "FC Dallas", "hou_mls": "Houston Dynamo",
    "lag_mls": "LA Galaxy", "laf_mls": "LAFC",
    "mia_mls": "Inter Miami", "min_mls": "Minnesota United",
    "mtl_mls": "CF Montreal", "nas_mls": "Nashville SC",
    "ner_mls": "New England Revolution", "nyc_mls": "New York City FC",
    "nyr_mls": "NY Red Bulls", "orl_mls": "Orlando City",
    "phi_mls": "Philadelphia Union", "por_mls": "Portland Timbers",
    "slc_mls": "Real Salt Lake", "sj_mls": "San Jose Earthquakes",
    "sea_mls": "Seattle Sounders", "stl_mls": "St. Louis City SC",
    ...
    "rma_soc2": "Real Madrid", "bar_soc": "Barcelona",
    # ── WNBA (suffixed with _wnba) ──
    "con_wnba": "Connecticut Sun", "ind_wnba": "Indiana Fever",
    "lib_wnba": "New York Liberty", "lyn_wnba": "Minnesota Lynx",
    "ace_wnba": "Las Vegas Aces", "sky_wnba": "Chicago Sky",
    "sto_wnba": "Seattle Storm", "win_wnba": "Dallas Wings",
    "mer_wnba": "Phoenix Mercury", "dre_wnba": "Atlanta Dream",
    "spa_wnba": "Los Angeles Sparks", "mys_wnba": "Washington Mystics",
    "fev_wnba": "Indiana Fever", "sun_wnba": "Connecticut Sun",
    "atl_wnba": "Atlanta Dream", "chi_wnba": "Chicago Sky",
    "dal_wnba": "Dallas Wings", "hou_wnba": "Houston Comets",
    "las_wnba": "Las Vegas Aces", "lal_wnba": "Los Angeles Sparks",
    "min_wnba": "Minnesota Lynx", "nyl_wnba": "New York Liberty",
    "phx_wnba": "Phoenix Mercury", "sea_wnba": "Seattle Storm",
...
_SPORT_KEY_TO_ABBREV_SUFFIX: dict[str, str] = {
    ...
    "baseball_mlb": "_mlb",
    "baseball_ncaa": "_mlb",
    # Soccer — all leagues share the _soc suffix
    "soccer": "_soc",
    "soccer_epl": "_soc",
    "soccer_usa_mls": "_mls",
    "soccer_spain_la_liga": "_soc",
    "soccer_germany_bundesliga": "_soc",
