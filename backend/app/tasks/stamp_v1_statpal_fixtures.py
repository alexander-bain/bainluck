...
class LeagueSpec:
    ...
    #: `soccer_team_matching.soccer_pair_matches` joins **74** (67 before its
    #: alias tables, #5829; 73 before its whole-name initialisms, #6022).
    #: Widening the NFL
    ...
    *,
    ...
    Args:
        ...
        pair_rule: does this StatPal (home, away) name the same fixture as this
            ...
            passes `soccer_pair_matches`, which joins 74 of the pinned 90 where
            equality joins 17.
    """
